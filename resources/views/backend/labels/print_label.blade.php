...
{{--
                ...
                @endif
                {{-- Barcode --}}
                <img style="max-width:120% !important;height: {{$barcode_details->height*0.33}}in !important; display: block;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($page_product['sub_sku'], $page_product['barcode_type'], 1,30, array(0, 0, 0), false)}}">
