        <ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
            ...
            $sale_type_permission_active = $role_has_permissions_list->where('name', 'sale-types-index')->first();
            ?>
            @if (
                ...
                <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i
                    ...
                    <ul id="sale" class="collapse list-unstyled ">
                        ...
                        @endif
                        @if ($sale_type_permission_active)
                            <li id="sale-type-menu"><a href="{{ route('sale-types.index') }}">Sale Types</a></li>
                        @endif
                        ...
                        @endif
                        <li id="courier-menu"><a
                                href="{{ route('couriers.index') }}">{{ trans('file.Courier List') }}</a> </li>
                    </ul>
                </li>
            @endif
            @if (in_array('manufacturing', explode(',', $general_setting->modules)))
                <li>
                    <a href="#manufacturing" aria-expanded="false" data-toggle="collapse"> <i
                            class="fa fa-industry"></i><span>{{ trans('file.Manufacturing') }}</span></a>
                    <ul id="manufacturing" class="collapse list-unstyled ">
                        <li id="production-list-menu"><a
                                href="{{ route('productions.index') }}">{{ trans('file.Production List') }}</a></li>
                        <li id="production-create-menu"><a
                                href="{{ route('productions.create') }}">{{ trans('file.Add Production') }}</a></li>
                    </ul>
                </li>
            @endif
            <?php
            ...
            @if (\Auth::user()->role_id != 5)
                ...
                @if (in_array('ecommerce', explode(',', $general_setting->modules)))
                    <li><a href="#ecommerce" aria-expanded="false" data-toggle="collapse"> <i
