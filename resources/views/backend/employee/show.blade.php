            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        @if($employee->image)
                            <img src="{{url('images/employee', $employee->image)}}" class="rounded-circle" width="150" height="150">
                        @else
                            <img src="{{url('images/product/zummXD2dvAtI.png')}}" class="rounded-circle" width="150" height="150">
                        @endif
                        <h3 class="mt-3">{{$employee->name}}</h3>
                        <p>{{$employee->email}}<br>{{$employee->phone_number}}</p>
                        <hr>
                        <h4>Balance</h4>
                        <h2 class="@if($employee->balance > 0) text-success @elseif($employee->balance < 0) text-danger @endif">
                        ...
                        <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#adjustBalanceModal">Adjust Balance</button>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#tasks" role="tab" data-toggle="tab">Task History</a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else <span class="badge badge-warning">{{$task->status}}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                            @empty
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="payroll">
                                <div class="table-responsive">
                                    ...
                                    <div class="text-right mt-3">
                                        <a href="{{route('payroll.index')}}" class="btn btn-link">View All Payroll Records</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div id="adjustBalanceModal" tabindex="-1" role="dialog" aria-labelledby="adjustBalanceModalLabel" aria-hidden="true" class="modal fade text-left">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="target_balance" class="form-control" step="any" required value="0">
