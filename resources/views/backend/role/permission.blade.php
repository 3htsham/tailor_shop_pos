                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('purchase-payment-index', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="purchase-payment-index" name="purchase-payment-index"
                                                                checked />
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="purchase-payment-index" name="purchase-payment-index">
                                                ...
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('purchase-payment-add', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="purchase-payment-add" name="purchase-payment-add"
                                                                checked />
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="purchase-payment-add" name="purchase-payment-add">
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('purchase-payment-edit', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="purchase-payment-edit" name="purchase-payment-edit"
                                                                checked>
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="purchase-payment-edit" name="purchase-payment-edit">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('sale-types-index', $all_permission))
                                                            <input type="checkbox" value="1" id="sale-types-index"
                                                                name="sale-types-index" checked />
                                                        @else
                                                            <input type="checkbox" value="1" id="sale-types-index"
                                                                name="sale-types-index" />
                                                        @endif
                                                        <label for="sale-types-index"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('sale-types-add', $all_permission))
                                                            <input type="checkbox" value="1" id="sale-types-add"
                                                                name="sale-types-add" checked />
                                                        @else
                                                            <input type="checkbox" value="1" id="sale-types-add"
                                                                name="sale-types-add" />
                                                        @endif
                                                        <label for="sale-types-add"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('sale-types-edit', $all_permission))
                                                            <input type="checkbox" value="1" id="sale-types-edit"
                                                                name="sale-types-edit" checked />
                                                        @else
                                                            <input type="checkbox" value="1" id="sale-types-edit"
                                                                name="sale-types-edit" />
                                                        @endif
                                                        <label for="sale-types-edit"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('sale-types-delete', $all_permission))
                                                            <input type="checkbox" value="1" id="sale-types-delete"
                                                                name="sale-types-delete" checked />
                                                        @else
                                                            <input type="checkbox" value="1" id="sale-types-delete"
                                                                name="sale-types-delete" />
                                                        @endif
                                                        <label for="sale-types-delete"></label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('sale-payment-delete', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="sale-payment-delete" name="sale-payment-delete"
                                                                checked>
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="sale-payment-delete" name="sale-payment-delete">
                                                ...
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('quotes-add', $all_permission))
                                                            <input type="checkbox" value="1" id="quotes-add"
                                                                name="quotes-add" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="quotes-add"
                                                                name="quotes-add">
                                                        @endif
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('purchase-return-index', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-index" name="purchase-return-index"
                                                                checked>
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-index" name="purchase-return-index">
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('purchase-return-add', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-add" name="purchase-return-add"
                                                                checked>
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-add" name="purchase-return-add">
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('purchase-return-edit', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-edit" name="purchase-return-edit"
                                                                checked>
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-edit" name="purchase-return-edit">
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('purchase-return-delete', $all_permission))
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-delete" name="purchase-return-delete"
                                                                checked>
                                                        @else
                                                            <input type="checkbox" value="1"
                                                                id="purchase-return-delete" name="purchase-return-delete">
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('tasks-index', $all_permission))
                                                            <input type="checkbox" value="1" id="tasks-index"
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('tasks-add', $all_permission))
                                                            <input type="checkbox" value="1" id="tasks-add"
                                                                name="tasks-add" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="tasks-add"
                                                                name="tasks-add">
                                                        @endif
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('tasks-edit', $all_permission))
                                                            <input type="checkbox" value="1" id="tasks-edit"
                                                                name="tasks-edit" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="tasks-edit"
                                                                name="tasks-edit">
                                                        @endif
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('tasks-delete', $all_permission))
                                                            <input type="checkbox" value="1" id="tasks-delete"
                                                                name="tasks-delete" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="tasks-delete"
                                                                name="tasks-delete">
                                                        @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('monthly_summary', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="monthly_summary" name="monthly_summary" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="monthly_summary" name="monthly_summary">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('yearly_report', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="yearly_report" name="yearly_report" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="yearly_report" name="yearly_report">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('account-index', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="account-index" name="account-index" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="account-index" name="account-index">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('money-transfer', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="money-transfer" name="money-transfer" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('balance-sheet', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="balance-sheet" name="balance-sheet" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('payroll', $all_permission))
                                                                <input type="checkbox" value="1" id="payroll"
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('holiday', $all_permission))
                                                                <input type="checkbox" value="1" id="holiday"
                                                                    name="holiday" checked>
                                                            @else
                                                                <input type="checkbox" value="1" id="holiday"
                                                                    name="holiday">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('monthly-sale', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="monthly-sale" name="monthly-sale" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="monthly-sale" name="monthly-sale">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('daily-purchase', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="daily-purchase" name="daily-purchase" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="daily-purchase" name="daily-purchase">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('product-report', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="product-report" name="product-report" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="product-report" name="product-report">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('payment-report', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="payment-report" name="payment-report" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="payment-report" name="payment-report">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('sale-report-chart', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="sale-report-chart" name="sale-report-chart"
                                                                    checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="sale-report-chart" name="sale-report-chart">
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('biller-report', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="biller-report" name="biller-report" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="biller-report" name="biller-report">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('supplier-due-report', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="supplier-due-report" name="supplier-due-report"
                                                                    checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="supplier-due-report" name="supplier-due-report">
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('custom_field', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="custom_field" name="custom_field" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="custom_field" name="custom_field">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('all_notification', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="all_notification" name="all_notification"
                                                                    checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="all_notification" name="all_notification">
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('discount_plan', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="discount_plan" name="discount_plan" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="discount_plan" name="discount_plan">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('discount', $all_permission))
                                                                <input type="checkbox" value="1" id="discount"
                                                                    name="discount" checked>
                                                            @else
                                                                <input type="checkbox" value="1" id="discount"
                                                                    name="discount">
                                                            @endif
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('customer_group', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="customer_group" name="customer_group" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                ...
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="brand"
                                                                class="padding05">{{ trans('file.Brand') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="unit"
                                                                class="padding05">{{ trans('file.Unit') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                ...
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="tax"
                                                                class="padding05">{{ trans('file.Tax') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                ...
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="coupon"
                                                                class="padding05">{{ trans('file.Coupon') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('product_history', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="product_history" name="product_history" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="product_history" name="product_history">
                                                            @endif
