						            	...
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="revenue_profit_summary" class="padding05">{{trans('file.Revenue and Profit Summary')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
						            		<div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="cash_flow" class="padding05">{{trans('file.Cash Flow')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="monthly_summary" class="padding05">{{trans('file.Monthly Summary')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="yearly_report" class="padding05">{{trans('file.yearly report')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="sale-report-chart" class="padding05">{{trans('file.Sale Report Chart')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	...
							                    	@endif
													<label for="product-expiry-report" class="padding05">{{trans('file.Product Expiry Report')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
								        </span>
								        <span>
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="biller-report" class="padding05">{{trans('file.Biller Report')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="supplier-due-report" class="padding05">{{trans('file.Supplier Due Report')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="due-report" class="padding05">{{trans('file.Customer Due Report')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
						            	...
						            	<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="custom_field" class="padding05">{{trans('file.Custom Field')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            	<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="all_notification" class="padding05">{{trans('file.All Notification')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            	<span>
						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="discount_plan" class="padding05">{{trans('file.Discount Plan')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="discount" class="padding05">{{trans('file.Discount')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            	<span>
                                        ...
                                        <span class="packing-slip-challan-section">
						            		<div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="packing_slip_challan" class="padding05">{{trans('file.Packing Slip & Challan')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	@endif
								                    <label for="product_history" class="padding05">{{trans('file.Product History')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
