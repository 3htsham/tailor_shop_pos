                                                        ...
                                                        @foreach ($lims_product_sale_data as $product_sale)
                                                            <tr>
                                                                ...
                                                                @if ($product_batch_data)
                                                                    ...
                                                                    <td>{{ date($general_setting->date_format, strtotime($product_batch_data->expired_date)) }}
                                                                    </td>
                                                                @else
                                                                    <td>
                                                                        <input type="hidden" class="product-batch-id"
                                                                ...
                                                                <input type="hidden" class="is-imei"
                                                                    value="{{ $product_data->is_imei }}" />
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="garment_sale_type_id" id="garment_sale_type_id"
                                                    class="form-control">
                                                    <option value="">Select Sale Type...</option>
                                                    @foreach ($sale_types as $type)
                                                        <option value="{{ $type->id }}"
                                                            @if ($lims_sale_data->garment_sale_type_id == $type->id) selected @endif>
                                                            {{ $type->name }} ({{ $type->measurement_unit }})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <div class="{{ 'col-md-' . $field->grid_value }}">
                                                    <div class="form-group">
                                                        ...
                                                        @elseif($field->type == 'textarea')
                                                            <textarea rows="5" name="{{ $field_name }}" value="{{ $lims_sale_data->$field_name }}"
                                                        ...
                                                        @elseif($field->type == 'select')
                                                            ...
                                                            <select class="form-control" name="{{ $field_name }}"
                                                                ...
                                                                @foreach ($option_values as $value)
                                                                    <option value="{{ $value }}"
                                                                        @if ($value == $lims_sale_data->$field_name) {{ 'selected' }} @endif>
                                                                        {{ $value }}</option>
                                                                @endforeach
                                                            </select>
