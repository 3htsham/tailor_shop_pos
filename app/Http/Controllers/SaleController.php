...
class SaleController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($role->hasPermissionTo('sales-add')) {
            ...
            $numberOfInvoice = Sale::count();
            $custom_fields = CustomField::where('belongs_to', 'sale')->whereNull('sale_type_id')->get();
            $lims_customer_group_all = CustomerGroup::where('is_active', true)->get();
            $sale_types = SaleType::where('is_active', true)->get();
            return view('backend.sale.create', compact('currency_list', 'lims_customer_list', 'lims_warehouse_list', 'lims_biller_list', 'lims_pos_setting_data', 'lims_tax_list', 'lims_reward_point_setting_data', 'options', 'numberOfInvoice', 'custom_fields', 'lims_customer_group_all', 'sale_types'));
        } else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function store(Request $request)
    {
        ...
        // return $data;
        if (isset($data['garment_sale_type_id']) && $data['garment_sale_type_id'])
            $data['garment_sale_type_id'] = $data['garment_sale_type_id'];
        else
            $data['garment_sale_type_id'] = null;
    ...
    public function edit($id)
    {
        ...
        if ($role->hasPermissionTo('sales-edit')) {
            ...
            $custom_fields = CustomField::where('belongs_to', 'sale')->whereNull('sale_type_id')->get();
            $sale_types = SaleType::where('is_active', true)->get();
            return view('backend.sale.edit', compact('lims_customer_list', 'lims_warehouse_list', 'lims_biller_list', 'lims_tax_list', 'lims_sale_data', 'lims_product_sale_data', 'currency_exchange_rate', 'custom_fields', 'sale_types'));
        } else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
